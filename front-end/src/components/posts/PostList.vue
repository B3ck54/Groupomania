    ...
    <v-row justify="center">
      <v-col>
        ...
        >
          ...
          <!-- <Comments />  v-for answer in answers ...-->
          <v-card-actions>
          ...
          <v-expand-transition>
            <div v-show="show">
              ...
              <!-- <v-row class="pa-3">
                <v-col>
                  <v-form v-model="valid" @submit.prevent="onSubmit(post.id)">
                    <v-text-field
                      name="input-1-3"
                    ...
                    <v-btn @click="onSubmitAnswer(post.id)" :disabled="!valid" small
                      >Poster</v-btn
                    >
                  </v-form>
                </v-col>
...
export default {
  data() {
    return {
      show: false,
      // comment: "",
      // commentUsername: this.User.username,
      valid: false,
    };
  },
  components: {
